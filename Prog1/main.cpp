...
---------------------------------------------------------------------------------------
 Fecha: 01/02/2023
 Autor: Andrés Felipe Ramírez Quintero
...
//se crea un TDA para los datos de los usuarios que se desean registrar
struct cliente
{
    string nombre;
    int edad;
...
int main ()
{
    int personas;
    int p;
    cout<<"********Bienvenido! Espero se encuentre muy bien el día de hoy el dia de hoy?********"<<endl;
    ...
    cout<<"los usuarios han sido registrados satisfactoriamente"<<endl;
    cout<<"los nombres de los usuarios registrados son: "<<endl;
    //imprime el nombre de los usuarios con un for
    for (int j=0; j<personas; j++)
    {
        cout<<clientes[j].nombre<<endl;
    }
    cout<<"Fin del programa, Feliz Día. "<<endl;
    return 0;
}
